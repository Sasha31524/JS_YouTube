...
function bindSlideToggle (trigger, boxBody, content, openClass) {
    ...
    button.element.addEventListener('click', () => {
        if (button.active === false){ //Проверка меню на активность
            button.active = true;
...
function start(){
    gapi.client.init({
        'apiKey': 'AIzaSyAgaw9Kmuc3_EO9xwDrVlRXa_W_XgTDnEI',
        'discoveryDocs': ['https://www.googleapis.com/discovery/v1/apis/youtube/v3/rest']
    }).then (function(){
        return gapi.client.youtube.playlistItems.list({
            "part": "snippet,contentDetails",
            "maxResults": '6',
            "playlistId": "LLEpMB9dWt1uLVUlbeKfTXPQ"
        })
...
document.addEventListener("scroll", function(){
    ...
    document.querySelector(".videos > .container").classList[elem.getBoundingClientRect().top < window.innerHeight ? "add" : "remove"]("visible");
